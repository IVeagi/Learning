...
![image](https://upload-images.jianshu.io/upload_images/15294843-ea2a652eb1c6cbd3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image](https://upload-images.jianshu.io/upload_images/15294843-557dd1bd86f907dc.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
`当然你需要把其中的192.168.1.1 6379替换为你自己的主服务器IP（或者主机名``hostname``）和端口。另外你可以调用SLAVEOF命令，`
...
`因为像DEBUG或者CONFIG这样的管理命令还是可以运行的。不过你可以通过使用rename-``command``命令来为这些命令改名来增加安全性。`
