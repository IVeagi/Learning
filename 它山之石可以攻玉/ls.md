...
![image](https://user-images.githubusercontent.com/30583971/157217657-3e0beaf6-9044-4a94-b603-d2152a13c95e.png)
...
![image](https://user-images.githubusercontent.com/30583971/157217857-c8f9d294-fd0a-49f8-9c84-a0f610df0f58.png)
![image](https://user-images.githubusercontent.com/30583971/157217870-19b09099-a326-4691-95a2-5226086ddd4f.png)
...
![image](https://user-images.githubusercontent.com/30583971/157218110-667cd203-6cc3-44ab-aef7-8028e8e3161d.png)

* (9) TCP如何保证传输的可靠性？
三次握手 + 四次挥手 + 拥塞控制 + 流量控制 + 超时重发 + 滑动窗口控制

* (10) tcp和udp的报文结构了解么
![image](https://user-images.githubusercontent.com/30583971/157218056-da0f129c-d992-48f2-a342-5b85a5f5ef9a.png)
![image](https://user-images.githubusercontent.com/30583971/157218077-4c13ffe2-0c39-4428-b87a-e91b5d1f79cf.png)


* (11) UDP有拥塞控制吗？UDP丢包原因？如何解决？
没有拥塞控制，解决方法 ：控制发送包的频率和大小，把大包切割多个小包一点一点去发送
![image](https://user-images.githubusercontent.com/30583971/157218157-b26686c6-a733-4207-aed5-59ff4bb84b32.png)
...
* (17) SYN攻击
![image](https://user-images.githubusercontent.com/30583971/157218233-be647597-2075-46ab-995a-e245260fcae9.png)
...
● 503 ：过载请求
● 504 ：网关超时
![image](https://user-images.githubusercontent.com/30583971/157218278-05eceba9-ee2a-48bd-ab62-68801557d07b.png)
...
### 16、Socket部分
![image](https://user-images.githubusercontent.com/30583971/157218358-699bf44a-671b-4e08-832e-895c4dfd554c.png)
...
(2) 三种实现方式
select、poll、epoll
![image](https://user-images.githubusercontent.com/30583971/157218446-12e192fa-1e16-4c6a-9eb0-9d305a7853b4.png)
...
![image](https://user-images.githubusercontent.com/30583971/157218596-c7bc6c0b-a32b-4d04-bcf8-2e43761ea772.png)
...
## 26、操作系统有哪些调度方式
![image](https://user-images.githubusercontent.com/30583971/157218669-5a5b2647-d122-4835-9f30-bbe090c2ff90.png)
![image](https://user-images.githubusercontent.com/30583971/157218699-40941dd0-4b7d-462a-a874-040a4f163c33.png)
...
## 50、linux启动过程
## 51、进程状态和线程状态有哪些
![image](https://user-images.githubusercontent.com/30583971/157218798-dc6afadf-709b-43ea-b357-0e8ba06fac25.png)
...
## 55、分页和分段的区别
![image](https://user-images.githubusercontent.com/30583971/157218848-ed5da91c-7822-437e-a198-1d53b399896e.png)
...
![image](https://user-images.githubusercontent.com/30583971/157218970-640eff45-00db-465d-97fb-20cfe5c4d825.png)
...
![image](https://user-images.githubusercontent.com/30583971/157219009-baa8ff0b-0433-41f5-9179-8e302705fc33.png)
...
![image](https://user-images.githubusercontent.com/30583971/157219083-73c18e63-7734-4bde-904f-fe0f70a252a0.png)
...
(19) Redis的多线程和单线程的瓶颈
Redis 6.0之后引入多线程
![image](https://user-images.githubusercontent.com/30583971/157219124-ff8355e0-9085-4dde-8760-1d81c91dfab3.png)
...
![image](https://user-images.githubusercontent.com/30583971/157219161-a19a413b-04d6-4a23-9eda-7c95ffcbb341.png)
...
![image](https://user-images.githubusercontent.com/30583971/157219379-6d522285-ec4a-451b-b051-3dd35636855f.png)
...
![image](https://user-images.githubusercontent.com/30583971/157219461-4536ee04-824d-4298-82a2-bbaac3d576ef.png)
![image](https://user-images.githubusercontent.com/30583971/157219495-49d0eb7f-2eda-467d-b5a4-b24b3ab7cced.png)
![image](https://user-images.githubusercontent.com/30583971/157219520-0bc3ac2b-69d5-44c6-949c-ee304507f291.png)
...
![image](https://user-images.githubusercontent.com/30583971/157219652-aef6387a-ab74-4719-afae-1641fe5b1121.png)
...
4、对数据库服务器的参数调优
![image](https://user-images.githubusercontent.com/30583971/157219718-c140fb6b-2fd6-4c4c-896d-48b0037e1a2f.png)
![image](https://user-images.githubusercontent.com/30583971/157219745-e0ec18fb-4f91-4021-ba55-cb3da2e65e75.png)
...
B+树一般不超过4层
![image](https://user-images.githubusercontent.com/30583971/157219768-6de78218-95c8-4436-8b0f-9af64c571a0f.png)
...
(45) 全文索引
![image](https://user-images.githubusercontent.com/30583971/157219819-84e43803-55b2-471f-814c-f0ba7c9f71c0.png)
![image](https://user-images.githubusercontent.com/30583971/157219831-e045fe82-4612-4975-a0d9-16acaff1b6e3.png)
...
(55) 索引列长度
![image](https://user-images.githubusercontent.com/30583971/157219869-6131ef8c-bd4f-4b97-bf1a-126ca29ea063.png)

(56) 索引分类
![image](https://user-images.githubusercontent.com/30583971/157219886-d89037dd-c6dc-4758-8ad3-43a67cb9e5e0.png)

(57) InnoDB间隙锁
![image](https://user-images.githubusercontent.com/30583971/157219918-7b7f2425-12ea-448d-876b-9f637107bdda.png)

(58) 查询成本
![image](https://user-images.githubusercontent.com/30583971/157219941-1753470b-963e-4f66-8aff-a4d70874fe6f.png)

(59) 死锁分析
![image](https://user-images.githubusercontent.com/30583971/157219952-c43a3453-f7e8-4095-97af-88551961e22d.png)

(60) MySQL两阶段提交

(61) or 查询的问题
OR查询可能会引起慢查询，解决方案可以用 Union 查询（实测发现Union也不行），或者是分两次查询把数据合在一起
![image](https://user-images.githubusercontent.com/30583971/157219980-3ec2faef-8d6b-45a5-985f-1eef2c1613c9.png)
...
![image](https://user-images.githubusercontent.com/30583971/157220007-ff39684b-51a7-47a3-a289-3a981b14393d.png)

(62) AND 查询的问题
![image](https://user-images.githubusercontent.com/30583971/157220034-1ec5e22b-1b90-46d7-80c2-233a86d8bc68.png)
...
![image](https://user-images.githubusercontent.com/30583971/157220162-3807b42b-daba-46a5-91fc-7b328203142b.png)

5、跳表
跳表的时间复杂度O(logn)
跳跃列表的平均查找和插入时间复杂度都是O(logn)
![image](https://user-images.githubusercontent.com/30583971/157220189-e4fff1e4-fd00-4be9-9802-afffad53491d.png)
